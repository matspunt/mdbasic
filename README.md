...
This is a molecular dynamics engine programmed in C++, which focuses on the barebones MD functionality. The goal of the project is to understand MD better, from both a theory and implementation perspective. 
...
The code should at least function correctly for a Lennard-Jones gas (Argon), before implementing bonded topologies which introduce a whole new layer of complexity.  
...
- Alchemical perturbation calculations.
- 
...
Some different parameters here: http://www.sklogwiki.org/SklogWiki/index.php/Argon
